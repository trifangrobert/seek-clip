...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.99\textwidth]{project_architecture.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.99\textwidth]{profile-new.png}
...
\begin{figure}[h]
    ...
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{video-edit.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.99\textwidth]{main-page-small.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{video-page-small.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{comment-section.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.95\textwidth]{search-bar-new.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{conversation.png}
...
\begin{figure}[h]
    ...
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[width=0.99\textwidth]{light-theme-new.png}
        \caption{Tema lumină}
        \label{fig:light-theme}
    \end{minipage}\hfill
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[width=0.99\textwidth]{dark-theme-new.png}
...
\begin{verbatim}
    ...
    Alg Cost      Salt                        Hash
\end{verbatim}
\footnotetext[1]{Exemplul este preluat de pe Wikipedia de la adresa: \url{https://en.wikipedia.org/wiki/Bcrypt}}
...
Astfel, obținem pentru fiecare bloc transcrierea (\textit{transcription}), valorile de intrare (\textit{input\_values})
...
\subsubsection{Dockerfile și Imagini Docker}
\par
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{docker.JPG}
    \caption{Docker\protect\footnotemark[4]}
    \label{fig:docker}
\end{figure}
\footnotetext[4]{Imagine preluată de pe site-ul \textit{SureSoft} la adresa: \url{https://suresoft.gitlab-pages.rz.tu-bs.de/workshop-website/continuous-integration/containers.html}}
